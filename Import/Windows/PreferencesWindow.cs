...
namespace Import.Windows {
    public class PreferencesWindow: Window {
        ...
        void UpdateTime(object sender, EventArgs e) {
            CurrentSession.Text = $"Current session: {Program.TimeSpent.Elapsed}";

            if (Preferences.Time >= (long)TimeSpan.MaxValue.TotalSeconds) Preferences.BaseTime = 0;

            AllTime.Text = $"All time: {Preferences.Time.Seconds()}";
        }
        ...
        void LocateImportConnector(object sender, RoutedEventArgs e) {
