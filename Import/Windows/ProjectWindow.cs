...
namespace Import.Windows {
    public class ProjectWindow: Window, ISelectParentViewer, IDroppable {
        ...
        void UpdateTime(object sender, EventArgs e) => TimeSpent.Text = $"Total time spent: {Program.Project.Time.Seconds()}";
        ...
        void Click(object sender, PointerReleasedEventArgs e) {
            ...
            if (MouseButton == PointerUpdateKind.RightButtonReleased)
                ((ImportContextMenu)this.Resources["TrackContextMenu"]).Open((Control)sender);
