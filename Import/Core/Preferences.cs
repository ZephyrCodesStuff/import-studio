...
namespace Import.Core {
    public static class Preferences {
        ...
        static readonly string FilePath = Path.Combine(Program.UserPath, "Import.config");
        static readonly string StatsPath = Path.Combine(Program.UserPath, "Import.stats");
