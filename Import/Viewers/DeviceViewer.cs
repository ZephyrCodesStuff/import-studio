...
namespace Import.Viewers {
    public class DeviceViewer: UserControl, ISelectViewer, IDraggable {
        ...
        static IControl GetSpecificViewer(DeviceViewer sender, Device device) {
            foreach (Type deviceViewer in Assembly.GetExecutingAssembly().GetTypes().Where(i => i.ReflectedType == null && i.Namespace.StartsWith("Import.DeviceViewers")))
        ...
        protected ImportContextMenu DeviceContextMenu, GroupContextMenu, ChokeContextMenu;
        ...
        public void DragFailed(PointerPressedEventArgs e) {
            ...
            if (MouseButton == PointerUpdateKind.RightButtonPressed) {
                ImportContextMenu menu = DeviceContextMenu;
